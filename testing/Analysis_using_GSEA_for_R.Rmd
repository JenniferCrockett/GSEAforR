...
library(scico)
library(lemon)
source(here("src", "R", "user_functions.R"))
...
plot_GSEA_results(result, fdr_q_cutoff = 0.05, control_group = "DNMT3A WT", experimental_group = "DNMT3A Mutant", order = -1, save_file = here("testing", "results", "GSEA_results_DNMT3A_Mut_vs_WT.png"))
```
